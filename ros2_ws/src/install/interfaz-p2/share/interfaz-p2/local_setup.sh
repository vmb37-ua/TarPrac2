...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/src/install/interfaz-p2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/interfaz-p2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/interfaz-p2/environment/path.sh"
