...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/src/install/p2pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/p2pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/p2pkg/environment/path.sh"
