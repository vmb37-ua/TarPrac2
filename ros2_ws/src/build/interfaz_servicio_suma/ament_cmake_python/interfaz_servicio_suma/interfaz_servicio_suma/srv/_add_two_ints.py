...
class Metaclass_AddTwoInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('interfaz_servicio_suma')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaz_servicio_suma.srv.AddTwoInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from interfaz_servicio_suma.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from interfaz_servicio_suma.srv._add_two_ints import AddTwoInts_Request as Request
    from interfaz_servicio_suma.srv._add_two_ints import AddTwoInts_Response as Response
