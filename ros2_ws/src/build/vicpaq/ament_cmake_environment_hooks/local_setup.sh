...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros2_ws/src/install/vicpaq"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vicpaq/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/vicpaq/environment/path.sh"
